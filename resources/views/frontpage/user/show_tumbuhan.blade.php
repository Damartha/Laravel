...
<head>
    ...
    <title>Detail {{ $data->nama_tumbuhan2 }}</title>
...
<body class="text-gray-800 bg-gray-100">
    <x-home-layout class="p-6">
        <div class="w-11/12 p-6 mx-auto my-10 bg-white rounded-lg shadow-md">
            ...
            <img src="{{ asset($data->path.$data->foto_tumbuhan2) }}" alt="">
            ...
            <div class="px-4 py-6 ">
                <table class="border-collapse ">
                    <tr class="border-b">
                        ...
                        <td class="p-2">:</td>
                        <td class="py-2">{{ $data->habitat_tumbuhan2 }}</td>
                    </tr>
                    <tr class="border-b">
                        <td class="py-2 font-semibold">Jenis</td>
                        <td class="p-2">:</td>
                        <td class="py-2">{{ $data->jenis_tumbuhan2 }}</td>
                    </tr>
                    <tr>
                        <td class="py-2 font-semibold">Deskripsi</td>
                        <td class="p-2">:</td>
                        <td class="py-2">{{ $data->deskripsi_tumbuhan2 }}</td>
                    </tr>
                </table>
            </div>
        </div>
